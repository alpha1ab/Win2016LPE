...
int mainf()
{
	...
	//hFind = FindFirstFile(L"C:\\Windows\\System32\\DriverStore\\FileRepository\\prnms003.inf_x86*", &FindFileData);
	...
	//wchar_t EndPath[23] = L"\\i386\\PrintConfig.dll";
	wmemcpy(PrinterDriverFolder, FindFileData.cFileName, wcslen(FindFileData.cFileName));
	//wmemcpy(PrinterDriverFolder, L"prnms003.inf_x86_ef6b839f0207c336", wcslen(L"prnms003.inf_x86_ef6b839f0207c336"));

	FindClose(hFind);
	wcscat_s(BeginPath, MAX_PATH, PrinterDriverFolder);
	...
	wmemcpy(PrinterDriverFolder, FindFileData.cFileName, wcslen(FindFileData.cFileName));
	wcscpy_s(BeginPath, MAX_PATH, L"c:\\windows\\system32\\DriverStore\\FileRepository\\");
	wcscat_s(BeginPath, MAX_PATH, PrinterDriverFolder);
	wcscat_s(BeginPath, MAX_PATH, EndPath);
